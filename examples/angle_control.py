...
async def main():
    ...
    try:
        while True:
            ...
            waypoint_to_turn = way_points[(current_waypoint_idx + 7) % len(way_points)]
            ...
            if current_waypoint_idx >25 and current_waypoint_idx < 75:
                next_speed_state = MEDIUMFAST
           
            elif current_speed_state == SLOW:
            ...
            if next_speed_state == FAST:
                ...
                throttle_control = 0.1 * (30 - np.linalg.norm(vehicle.get_linear_3d_velocity()))
