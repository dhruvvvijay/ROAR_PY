...
async def main():
    ...
    try:
        while True:
            ...
            # Print the current waypoint's x and y coordinates
            #current_waypoint = way_points[current_waypoint_idx]
            #print(f"Current waypoint: x={current_waypoint.location[0]}, y={current_waypoint.location[1]}")
